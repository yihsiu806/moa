...
if (user && user.role) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#roleSelect').val(user.role);
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#username, #passowrd').on('input', function () {
  var limit = 100;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="text"], input[type="password"]').on('input', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('input.is-invalid').removeClass('is-invalid border-red-500'); // $('#editUserSavedInfo').hide();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#editUserForm').on('submit', function (event) {
  event.preventDefault();
  var validate = true;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#editUserForm').on('submit', function (event) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_2___default().patch('/user/edit', data).then(function () {
    sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      title: 'Success',
      icon: 'success',
      text: 'Change has saved!',
      confirmButtonColor: '#056839'
    }).then(function () {// $('#editUserSavedInfo').show();
    });
  })["catch"](function (error) {
    console.log(error);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#resetPasswordForm').on('submit', function (event) {
  event.preventDefault();
  var validate = true;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#resetPasswordForm').on('submit', function (event) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_2___default().patch('/user/reset', data).then(function () {
    sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      title: 'Success',
      icon: 'success',
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#deleteUserBtn').on('click', function () {
  var promise;
  ...
  promise = promise.then(function (result) {
    if (result.isConfirmed) {
      return axios__WEBPACK_IMPORTED_MODULE_2___default().patch('/user/delete', {
        id: userId
      });
    } else {
  ...
  promise.then(function () {
    sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      title: 'Deleted!',
      icon: 'success',
      text: "User '".concat(user.username, "' has been deleted."),
      confirmButtonColor: '#056839'
    }).then(function () {
