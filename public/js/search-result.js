...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('#searchResultCount').text(0);
var promise = getSearchResult(0);

function getSearchResult(next) {
  return axios__WEBPACK_IMPORTED_MODULE_2___default().post('/search', {
    query: searchQuery,
    start: next
  }).then(function (res) {
