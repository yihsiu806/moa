    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex h-16">
            ...
            <div class="grow flex items-center">
                <div class="grow relative text-gray-600">
                    <input class="block w-4/6 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none focus:ring focus:ring-yellow focus:ring-opacity-40'"
