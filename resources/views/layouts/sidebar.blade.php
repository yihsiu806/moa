<x-sidebar-link href="/divisions/welcome" :active="request()->routeIs('/divisions/welcome')">
    <x-slot name="icon">
...
@foreach ($divisions as $division)
    <x-sidebar-link :href="'/divisions/'.$division->slug" :active="request()->routeIs('/divisions/'.$division->slug)">
        <x-slot name="icon">
            {!! $division->icon !!}
        </x-slot>
        {{ $division->name }}
