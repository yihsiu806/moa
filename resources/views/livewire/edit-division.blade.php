    ...
    <form id="modifyDivisionForm" method="POST" action="{{ route('patchDivision') }}">
        ...
        <div class="flex flex-wrap mb-6">
            <div class="w-full md:w-1/2 pr-3">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-yellow focus:ring-yellow"
        ...
        <div class="flex flex-wrap">
            <div class="">
                <img id="officerPicture"
                    class="inline-block overflow-hidden w-[120px] h-[120px] rounded-[35px] bg-white shadow-[0_0_0_1px_rgba(27,31,36,0.15)]"
