<div>
    ...
    <h1 class="mb-5 text-grey-dark text-3xl font-bold">Edit User</h1>
    ...
    <h1 class="mt-10 mb-5 text-grey-dark text-3xl font-bold">Reset Password</h1>
    <form id="addNewUserForm" method="POST">
        <div class="grid grid-cols-1 md:inline-grid md:grid-cols-[1fr_minmax(350px,_2fr)] md:gap-4">
    ...
    <h1 class="mt-10 mb-5 text-grey-dark text-3xl font-bold">Delete User</h1>
    <div class="mt-2">
        <button type="submit" class="mt-6 inline-block px-7 py-3 bg-green text-white font-medium text-base leading-snug uppercase rounded shadow-md hover:bg-green-light hover:shadow-lg focus:bg-green-light focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-light active:shadow-lg transition duration-150 ease-in-out">Delete User</button>
    </div>
</div>
<script>
    let user = @js($user);
