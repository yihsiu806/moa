<div class="container mx-auto mb-10">
    ...
    <h1 class="mb-5 text-grey-dark text-3xl font-bold">Edit File</h1>
        ...
        <div class="grid grid-cols-1 md:inline-grid md:grid-cols-[1fr_minmax(350px,_2fr)] md:gap-4">
            <div class="md:col-span-2 mb-2">
                <div id="selectFileAreaWrapper"
                    ...
                    {{-- select file --}}
                    <div id="selectFileModeOn" class="hidden">
                    ...
                    {{-- remove file --}}
                    <div id="selectFileModeOff" class="">
...
<script src="{{ asset('js/file-edit.js') }}" defer></script>
