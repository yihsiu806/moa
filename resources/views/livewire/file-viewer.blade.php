<div class="px-5 md:px-10">
    <div class="flex flex-wrap">
        <div class="w-full xl:w-1/2 flex flex-nowrap items-center">
        ...
        <div class="mt-2 xl:mt-0 w-full xl:w-1/2 flex flex-nowrap">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[80px_minmax(100px,_1fr)] gap-x-1 gap-y-0 font-semibold">
                <span class="text-gray-500">Name</span>
                <span id="officerName" class="mb-1 lg:mb-0 text-gray-700 font-medium"></span>
                <span class="text-gray-500">Position</span>
                <span id="officerPosition" class="mb-1 lg:mb-0 text-gray-700 font-medium"></span>
                <span class="text-gray-500">Telephone</span>
                <span id="officerTelephone" class="mb-1 lg:mb-0 text-gray-700 font-medium"></span>
                <span class="text-gray-500">Email</span>
                <span id="officerEmail" class="mb-1 lg:mb-0 text-gray-700 font-medium"></span>
            </div>
        </div>
    </div>
